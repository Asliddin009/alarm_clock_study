...
import '../../../feature/auth/domain/auth_state/auth_cubit.dart' as _i7;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i5.AuthRepository>(() => _i6.MockAuthRepository());
  gh.singleton<_i7.AuthCubit>(_i7.AuthCubit(get<_i5.AuthRepository>()));
  return get;
}
